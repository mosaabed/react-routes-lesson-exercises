...
class Home extends Component {
    render() {
        return (
            <div><div id="u-input">
                <input type="text" placeholder="Ask and you shall receive" /><div id="button">Seek</div></div>
                    ...
                    <div id="world">
                        ...
                        <Link to="/directory/wizards">
                            <div id="wizards">
                                ...
                                </div></Link><Link to="/directory/bestiary">
                                    <div id="bestiary">
                                        ...
                                        <div id="potions">
                                            ...
                                            </div><div id="deities"><span className="main-directory-text">Deities</span>
                                            </div></div></div>
        );
    }
}
